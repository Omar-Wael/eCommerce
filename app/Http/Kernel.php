...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            \Illuminate\Routing\Middleware\ThrottleRequests::class,
            \Illuminate\Cookie\Middleware\AddQueuedCookiesToResponse::class,
            // Add the middleware here if needed
            \App\Http\Middleware\ResetLocale::class, // Your custom ResetLocale middleware
        ],
    ...
    protected $routeMiddleware = [
        ...
        // Custom middleware
        'reset.locale' => \App\Http\Middleware\ResetLocale::class, // Register ResetLocale middleware here
    ];
}